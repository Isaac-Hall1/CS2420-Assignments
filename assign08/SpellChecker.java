...
public class SpellChecker {
	...
	public BinarySearchTree<String> dictionary;
	...
	public List<String> spellCheck(File documentFile) {
		...
		// for every word in wordstocheck, checks if the dictionary doesn't contain it
		// if thats the case we add it to our output list
